...
public class TrackFactoryTest {
	...
	public void setUp() throws Exception {
		...
		segment.addPoint(new GPXTrackPoint(new BigDecimal(0), new BigDecimal(0), new BigDecimal(0), new DateTime()));
		segment.addPoint(new GPXTrackPoint(new BigDecimal(10), new BigDecimal(10), new BigDecimal(10), new DateTime()));

		track.addTrackSegment(segment);
		GPXTrackSegment segment2 = new GPXTrackSegment();
		segment2.addPoint(new GPXTrackPoint(new BigDecimal(0), new BigDecimal(0), new BigDecimal(0), new DateTime()));
		segment2.addPoint(new GPXTrackPoint(new BigDecimal(10), new BigDecimal(10), new BigDecimal(10), new DateTime()));
